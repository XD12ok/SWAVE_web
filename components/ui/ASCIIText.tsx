...
class CanvAscii {
  ...
  async init(
    ...
    this.setMesh(text, textFontSize, textColor, planeBaseHeight, enableWaves);
    this.setRenderer(asciiFontSize);
  }
  ...
  setRenderer(asciiFontSize: number) {
...
export default function ASCIIText({
  ...
  useEffect(() => {
    ...
    const createAndInit = async (
      ...
      await instance.init(text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves);
      return instance;
    };
